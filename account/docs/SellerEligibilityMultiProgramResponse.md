...
------------ | ------------- | ------------- | -------------
**advertising_eligibility** | [**List[SellerEligibilityResponse]**](SellerEligibilityResponse.md) | An array of response fields that define the seller eligibility for eBay advertising programs. | [optional] 
