...
class FulfillmentPolicyRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["categoryTypes", "description", "freightShipping", "globalShipping", "handlingTime", "localPickup", "marketplaceId", "name", "pickupDropOff", "shippingOptions", "shipToLocations"]
