...
class Programs(BaseModel):
    ...
    """ # noqa: E501
    programs: Optional[List[Program]] = Field(default=None, description="An array of seller programs that the seller's account is opted in to. An empty array is returned if the seller is not opted in to any of the seller programs.")
