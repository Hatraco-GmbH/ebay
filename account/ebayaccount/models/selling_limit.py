...
class SellingLimit(BaseModel):
    ...
    quantity: Optional[StrictInt] = Field(default=None, description="This field shows the monthly cap for total quantity sold allowed for the seller's account. This field may not be returned if a seller does not have a monthly cap for total quantity sold.")
