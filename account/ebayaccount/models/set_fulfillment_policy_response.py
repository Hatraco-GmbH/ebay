...
class SetFulfillmentPolicyResponse(BaseModel):
    ...
    name: Optional[StrictStr] = Field(default=None, description="A seller-defined name for this fulfillment business policy. <br><br><b>Max length</b>: 64")
    pickup_drop_off: Optional[StrictBool] = Field(default=None, description="If returned as <code>true</code>, the seller offers the \"Click and Collect\" option. <br><br>Currently, \"Click and Collect\" is available only to large retail merchants the eBay AU, UK, DE, FR, and IT marketplaces.", alias="pickupDropOff")
    ...
    __properties: ClassVar[List[str]] = ["categoryTypes", "description", "freightShipping", "fulfillmentPolicyId", "globalShipping", "handlingTime", "localPickup", "marketplaceId", "name", "pickupDropOff", "shippingOptions", "shipToLocations", "warnings"]
