    ...
    def make_instance(self, include_optional) -> SetReturnPolicyResponse:
        ...
        if include_optional:
            return SetReturnPolicyResponse(
                ...
                international_override = ebayaccount.models.international_return_override_type.InternationalReturnOverrideType(
                    return_method = '', 
                    return_period = ebayaccount.models.time_duration.TimeDuration(
                        unit = '', 
                        value = 56, ), 
