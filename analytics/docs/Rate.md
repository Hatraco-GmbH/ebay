...
------------ | ------------- | ------------- | -------------
**count** | **int** | The number of calls a user has made to this resource within a set time period. This time period is defined by the associated &lt;b&gt;timeWindow&lt;/b&gt; value. | [optional] 
...
```python
from ebayanalytics.models.rate import Rate
