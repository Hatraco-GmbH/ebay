# ebayanalytics.UserRateLimitApi
...
from ebayanalytics.models.rate_limits_response import RateLimitsResponse
...
with ebayanalytics.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = ebayanalytics.UserRateLimitApi(api_client)
