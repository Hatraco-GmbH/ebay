...
from ebayanalytics.api_response import ApiResponse, T as ApiResponseT
import ebayanalytics.models
from ebayanalytics import rest
from ebayanalytics.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(ebayanalytics.models, klass)
