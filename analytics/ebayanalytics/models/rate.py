...
class Rate(BaseModel):
    ...
    """ # noqa: E501
    count: Optional[StrictInt] = Field(default=None, description="The number of calls a user has made to this resource within a set time period. This time period is defined by the associated <b>timeWindow</b> value.")
    ...
    __properties: ClassVar[List[str]] = ["count", "limit", "remaining", "reset", "timeWindow"]
