...
class Amount(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["convertedFromCurrency", "convertedFromValue", "convertedToCurrency", "convertedToValue", "currency", "exchangeRate", "value"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "convertedToCurrency": obj.get("convertedToCurrency"),
            "convertedToValue": obj.get("convertedToValue"),
