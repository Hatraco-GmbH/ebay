...
class PayoutInstrument(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "payoutPercentage": obj.get("payoutPercentage")
        })
        return _obj
