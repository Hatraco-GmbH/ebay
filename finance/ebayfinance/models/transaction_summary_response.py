...
class TransactionSummaryResponse(BaseModel):
    ...
    purchase_amount: Optional[Amount] = Field(default=None, alias="purchaseAmount")
    purchase_booking_entry: Optional[StrictStr] = Field(default=None, description="<span class=\"tablenote\"><b>Note:</b> The <code>PURCHASE</code> transaction type is currently only applicable in the US marketplace.</span><br>This enumeration value indicates whether the dollar amount in the <b>purchase</b> field is a charge (debit) to the seller or a credit. For implementation help, refer to <a href='https://developer.ebay.com/api-docs/sell/finances/types/pay:BookingEntryEnum'>eBay API documentation</a>", alias="purchaseBookingEntry")
    purchase_count: Optional[StrictInt] = Field(default=None, description="<span class=\"tablenote\"><b>Note:</b> The <code>PURCHASE</code> transaction type is currently only applicable in the US marketplace.</span><br>This integer value indicates the total number of purchases that have been initiated by a seller using spendable funds that match the input criteria.<br><br>This field is generally returned, even if it equals <code>0</code>. However, it will not be returned if a <code>transactionType</code> filter is used and its value has been set to any enumeration value other than <code>PURCHASE</code>.", alias="purchaseCount")
    ...
    shipping_label_booking_entry: Optional[StrictStr] = Field(default=None, description="The enumeration value indicates whether the dollar amount in the <strong>shippingLabelAmount</strong> field is a charge (debit) to the seller or a credit. Typically, the enumeration value returned here will be <code>DEBIT</code>, as eBay will charge the seller when eBay shipping labels are purchased, but it can be <code>CREDIT</code> if the seller was refunded for a shipping label or was possibly overcharged for a shipping label. <br><br><span class=\"tablenote\"><b>Note:</b> eBay SHIPPING_LABEL transactions paid through PayPal are not currently supported by the Finances API, so those transactions will not be reflected in this field.</span> For implementation help, refer to <a href='https://developer.ebay.com/api-docs/sell/finances/types/pay:BookingEntryEnum'>eBay API documentation</a>", alias="shippingLabelBookingEntry")
    shipping_label_count: Optional[StrictInt] = Field(default=None, description="This is the total number of eBay shipping labels purchased by the seller. The count returned here may depend on the specified input criteria.<br><br><span class=\"tablenote\"><b>Note:</b> eBay SHIPPING_LABEL transactions paid through PayPal are not currently supported by the Finances API, so those transactions will not be reflected in the count returned in this container.</span>", alias="shippingLabelCount")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "purchaseAmount": Amount.from_dict(obj["purchaseAmount"]) if obj.get("purchaseAmount") is not None else None,
            "purchaseBookingEntry": obj.get("purchaseBookingEntry"),
