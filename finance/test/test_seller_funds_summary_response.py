    ...
    def make_instance(self, include_optional) -> SellerFundsSummaryResponse:
        ...
        if include_optional:
            return SellerFundsSummaryResponse(
                available_funds = ebayfinance.models.amount.Amount(
                    ...
                    exchange_rate = '', 
                    value = '', ),
                funds_on_hold = ebayfinance.models.amount.Amount(
                    converted_from_currency = '', 
                    converted_from_value = '', 
                    converted_to_currency = '', 
                    converted_to_value = '', 
                    ...
                    exchange_rate = '', 
                    value = '', ),
                processing_funds = ebayfinance.models.amount.Amount(
                    converted_from_currency = '', 
                    converted_from_value = '', 
                    converted_to_currency = '', 
                    converted_to_value = '', 
                    ...
                    exchange_rate = '', 
                    value = '', ),
                total_funds = ebayfinance.models.amount.Amount(
                    converted_from_currency = '', 
                    converted_from_value = '', 
                    converted_to_currency = '', 
                    converted_to_value = '', 
