...
**charges** | [**List[Charge]**](Charge.md) | This array shows any charges that eBay collects from the buyer.&lt;br&gt;&lt;br&gt;&lt;span class&#x3D;\&quot;tablenote\&quot;&gt;&lt;strong&gt; Note: &lt;/strong&gt; Currently, the only supported charge type is BUYER_PROTECTION.&lt;/span&gt; | [optional] 

## Example

```python
from ebayfulfillment.models.ebay_collected_charges import EbayCollectedCharges
