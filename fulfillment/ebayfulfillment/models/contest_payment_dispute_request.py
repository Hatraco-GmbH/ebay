...
class ContestPaymentDisputeRequest(BaseModel):
    ...
    """ # noqa: E501
    note: Optional[StrictStr] = Field(default=None, description="This field shows information that the seller provides about the dispute, such as the basis for the dispute, any relevant evidence, tracking numbers, and so forth.<br><br><b>Max Length:</b> 1000 characters.")
