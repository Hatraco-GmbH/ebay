...
class FulfillmentStartInstruction(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["appointment", "ebaySupportedFulfillment", "finalDestinationAddress", "fulfillmentInstructionsType", "maxEstimatedDeliveryDate", "minEstimatedDeliveryDate", "pickupStep", "shippingStep"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "appointment": AppointmentDetails.from_dict(obj["appointment"]) if obj.get("appointment") is not None else None,
