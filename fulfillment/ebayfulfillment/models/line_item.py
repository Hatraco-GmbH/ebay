...
class LineItem(BaseModel):
    ...
    compatibility_properties: Optional[List[ModelProperty]] = Field(default=None, description="This array is only returned for a Parts & Accessory item, and identifies the buyer's motor vehicle that is compatible with the part or accessory.", alias="compatibilityProperties")
    ...
    title: Optional[StrictStr] = Field(default=None, description="The title of the listing.<br><br><span class=\"tablenote\"><b>Note:</b> The Item ID value for the listing will be returned in this field instead of the actual title if this particular listing is on-hold due to an eBay policy violation.</span>")
    ...
    __properties: ClassVar[List[str]] = ["appliedPromotions", "compatibilityProperties", "deliveryCost", "discountedLineItemCost", "ebayCollectAndRemitTaxes", "ebayCollectedCharges", "giftDetails", "itemLocation", "legacyItemId", "legacyVariationId", "lineItemCost", "lineItemFulfillmentInstructions", "lineItemFulfillmentStatus", "lineItemId", "linkedOrderLineItems", "listingMarketplaceId", "properties", "purchaseMarketplaceId", "quantity", "refunds", "sku", "soldFormat", "taxes", "title", "total", "variationAspects"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "compatibilityProperties": [ModelProperty.from_dict(_item) for _item in obj["compatibilityProperties"]] if obj.get("compatibilityProperties") is not None else None,
