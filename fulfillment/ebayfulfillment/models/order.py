...
class Order(BaseModel):
    ...
    order_id: Optional[StrictStr] = Field(default=None, description="The unique identifier of the order. This field is always returned.", alias="orderId")
