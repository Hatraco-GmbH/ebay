...
class ReturnAddress(BaseModel):
    ...
    country: Optional[StrictStr] = Field(default=None, description="The country's two-letter, ISO 3166-1 country code. See the enumeration type for a country's value. For implementation help, refer to <a href='https://developer.ebay.com/api-docs/sell/fulfillment/types/ba:CountryCodeEnum'>eBay API documentation</a>")
