...
**notes** | **str** | This field is used by the seller to input any notes pertaining to the compatible vehicle list being defined. The seller might use this field to specify the placement of the part on a vehicle or other applicable information.&lt;br&gt;&lt;br&gt;This field will only be returned if specified by the seller.&lt;br&gt;&lt;br&gt;&lt;strong&gt;Max Length&lt;/strong&gt;: 500&lt;br&gt; | [optional] 
**product_family_properties** | [**ProductFamilyProperties**](ProductFamilyProperties.md) |  | [optional] 
...
compatible_product_instance = CompatibleProduct.from_json(json)
# print the JSON string representation of the object
print(CompatibleProduct.to_json())

# convert the object into a dict
compatible_product_dict = compatible_product_instance.to_dict()
# create an instance of CompatibleProduct from a dict
compatible_product_from_dict = CompatibleProduct.from_dict(compatible_product_dict)
```
