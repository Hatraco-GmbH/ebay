...
> BulkInventoryItemResponse bulk_create_or_replace_inventory_item(content_type, content_language, bulk_inventory_item)
...
> BulkGetInventoryItemResponse bulk_get_inventory_item(content_type, bulk_get_inventory_item)
...
with ebayinventory.ApiClient(configuration) as api_client:
    ...
    api_instance = ebayinventory.InventoryItemApi(api_client)
    content_type = 'content_type_example' # str | This header indicates the format of the request body provided by the client. Its value should be set to <b>application/json</b>. <br><br>For more information, refer to <a href=\"/api-docs/static/rest-request-components.html#HTTP\" target=\"_blank \">HTTP request headers</a>.
    bulk_get_inventory_item = ebayinventory.BulkGetInventoryItem() # BulkGetInventoryItem | Details of the inventories with sku and locale

    try:
        api_response = api_instance.bulk_get_inventory_item(content_type, bulk_get_inventory_item)
        print("The response of InventoryItemApi->bulk_get_inventory_item:\n")
        pprint(api_response)
    except Exception as e:
...
> BulkPriceQuantityResponse bulk_update_price_quantity(content_type, bulk_price_quantity)
...
with ebayinventory.ApiClient(configuration) as api_client:
    ...
    api_instance = ebayinventory.InventoryItemApi(api_client)
    content_type = 'content_type_example' # str | This header indicates the format of the request body provided by the client. Its value should be set to <b>application/json</b>. <br><br>For more information, refer to <a href=\"/api-docs/static/rest-request-components.html#HTTP\" target=\"_blank \">HTTP request headers</a>.
    bulk_price_quantity = ebayinventory.BulkPriceQuantity() # BulkPriceQuantity | Price and allocation details for the given SKU and Marketplace

    try:
        api_response = api_instance.bulk_update_price_quantity(content_type, bulk_price_quantity)
        print("The response of InventoryItemApi->bulk_update_price_quantity:\n")
        pprint(api_response)
    except Exception as e:
...
> BaseResponse create_or_replace_inventory_item(content_language, sku, content_type, inventory_item)
...
with ebayinventory.ApiClient(configuration) as api_client:
    ...
    content_type = 'content_type_example' # str | This header indicates the format of the request body provided by the client. Its value should be set to <b>application/json</b>. <br><br>For more information, refer to <a href=\"/api-docs/static/rest-request-components.html#HTTP\" target=\"_blank \">HTTP request headers</a>.
    inventory_item = ebayinventory.InventoryItem() # InventoryItem | Details of the inventory item record.

    try:
        api_response = api_instance.create_or_replace_inventory_item(content_language, sku, content_type, inventory_item)
        print("The response of InventoryItemApi->create_or_replace_inventory_item:\n")
        pprint(api_response)
    except Exception as e:
...
with ebayinventory.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of InventoryItemApi->get_inventory_item:\n")
        pprint(api_response)
    except Exception as e:
...
with ebayinventory.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of InventoryItemApi->get_inventory_items:\n")
        pprint(api_response)
    except Exception as e:
