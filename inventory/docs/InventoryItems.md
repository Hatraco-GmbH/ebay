...
inventory_items_instance = InventoryItems.from_json(json)
# print the JSON string representation of the object
print(InventoryItems.to_json())

# convert the object into a dict
inventory_items_dict = inventory_items_instance.to_dict()
# create an instance of InventoryItems from a dict
inventory_items_from_dict = InventoryItems.from_dict(inventory_items_dict)
```
