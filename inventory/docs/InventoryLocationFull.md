...
**location_additional_information** | **str** | This text field is used by the merchant to provide additional information about an inventory location. &lt;br&gt;&lt;br&gt;&lt;b&gt;Max length&lt;/b&gt;: 256 | [optional] 
...
inventory_location_full_instance = InventoryLocationFull.from_json(json)
# print the JSON string representation of the object
print(InventoryLocationFull.to_json())

# convert the object into a dict
inventory_location_full_dict = inventory_location_full_instance.to_dict()
# create an instance of InventoryLocationFull from a dict
inventory_location_full_from_dict = InventoryLocationFull.from_dict(inventory_location_full_dict)
```
