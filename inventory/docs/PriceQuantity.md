...
price_quantity_instance = PriceQuantity.from_json(json)
# print the JSON string representation of the object
print(PriceQuantity.to_json())

# convert the object into a dict
price_quantity_dict = price_quantity_instance.to_dict()
# create an instance of PriceQuantity from a dict
price_quantity_from_dict = PriceQuantity.from_dict(price_quantity_dict)
```
