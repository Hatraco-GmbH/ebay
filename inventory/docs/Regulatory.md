...
regulatory_instance = Regulatory.from_json(json)
# print the JSON string representation of the object
print(Regulatory.to_json())

# convert the object into a dict
regulatory_dict = regulatory_instance.to_dict()
# create an instance of Regulatory from a dict
regulatory_from_dict = Regulatory.from_dict(regulatory_dict)
```
