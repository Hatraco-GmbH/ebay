...
------------ | ------------- | ------------- | -------------
**availability_distributions** | [**List[AvailabilityDistribution]**](AvailabilityDistribution.md) | This container is used to set the available quantity of the inventory item at one or more warehouse locations.&lt;br&gt;&lt;br&gt;This container will be returned if available quantity is set for one or more inventory locations. | [optional] 
...
ship_to_location_availability_instance = ShipToLocationAvailability.from_json(json)
# print the JSON string representation of the object
print(ShipToLocationAvailability.to_json())

# convert the object into a dict
ship_to_location_availability_dict = ship_to_location_availability_instance.to_dict()
# create an instance of ShipToLocationAvailability from a dict
ship_to_location_availability_from_dict = ShipToLocationAvailability.from_dict(ship_to_location_availability_dict)
```
