...
varies_by_instance = VariesBy.from_json(json)
# print the JSON string representation of the object
print(VariesBy.to_json())

# convert the object into a dict
varies_by_dict = varies_by_instance.to_dict()
# create an instance of VariesBy from a dict
varies_by_from_dict = VariesBy.from_dict(varies_by_dict)
```
