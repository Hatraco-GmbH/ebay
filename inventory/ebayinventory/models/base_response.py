...
class BaseResponse(BaseModel):
    ...
    """ # noqa: E501
    warnings: Optional[List[Error]] = Field(default=None, description="This container will be returned in a call response payload if one or more warnings or errors are triggered when an Inventory API call is made. This container will contain detailed information about the error or warning.")
