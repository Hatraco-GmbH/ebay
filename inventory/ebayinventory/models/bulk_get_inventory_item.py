...
class BulkGetInventoryItem(BaseModel):
    """
    This type is used by the base request of the <strong>bulkGetInventoryItem</strong> method.
    """ # noqa: E501
    requests: Optional[List[GetInventoryItem]] = Field(default=None, description="The seller passes in multiple SKU values under this container to retrieve multiple inventory item records. Up to 25 inventory item records can be retrieved at one time.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "requests": [GetInventoryItem.from_dict(_item) for _item in obj["requests"]] if obj.get("requests") is not None else None
        })
        return _obj
