...
class BulkInventoryItemResponse(BaseModel):
    ...
    """ # noqa: E501
    responses: Optional[List[InventoryItemResponse]] = Field(default=None, description="This is the base container of the <strong>bulkCreateOrReplaceInventoryItem</strong> response. The results of each attempted inventory item creation/update is captured under this container.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "responses": [InventoryItemResponse.from_dict(_item) for _item in obj["responses"]] if obj.get("responses") is not None else None
        })
        return _obj
