...
class BulkMigrateListingResponse(BaseModel):
    """
    This type is used by the response payload of the <strong>bulkMigrateListings</strong> call.
    """ # noqa: E501
    responses: Optional[List[MigrateListingResponse]] = Field(default=None, description="This is the base container of the response payload of the <strong>bulkMigrateListings</strong> call. The results of each attempted listing migration is captured under this container.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "responses": [MigrateListingResponse.from_dict(_item) for _item in obj["responses"]] if obj.get("responses") is not None else None
        })
        return _obj
