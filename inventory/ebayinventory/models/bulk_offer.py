...
class BulkOffer(BaseModel):
    ...
    """ # noqa: E501
    requests: Optional[List[OfferKeyWithId]] = Field(default=None, description="This container is used to pass in an array of offers to publish. Up to 25 offers can be published with one <strong>bulkPublishOffer</strong> method.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "requests": [OfferKeyWithId.from_dict(_item) for _item in obj["requests"]] if obj.get("requests") is not None else None
        })
        return _obj
