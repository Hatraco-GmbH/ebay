...
class BulkPriceQuantity(BaseModel):
    """
    ...
    """ # noqa: E501
    requests: Optional[List[PriceQuantity]] = Field(default=None, description="This container is used by the seller to update the total 'ship-to-home' quantity of one or more inventory items (up to 25) and/or to update the price and/or quantity of one or more specific published offers.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "requests": [PriceQuantity.from_dict(_item) for _item in obj["requests"]] if obj.get("requests") is not None else None
        })
        return _obj
