...
class BulkPublishResponse(BaseModel):
    ...
    """ # noqa: E501
    responses: Optional[List[OfferResponseWithListingId]] = Field(default=None, description="A node is returned under the <strong>responses</strong> container to indicate the success or failure of each offer that the seller was attempting to publish.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "responses": [OfferResponseWithListingId.from_dict(_item) for _item in obj["responses"]] if obj.get("responses") is not None else None
        })
        return _obj
