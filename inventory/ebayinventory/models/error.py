...
class Error(BaseModel):
    ...
    domain: Optional[StrictStr] = Field(default=None, description="The name of the domain in which the error or warning occurred.")
    ...
    input_ref_ids: Optional[List[StrictStr]] = Field(default=None, description="An array of one or more reference IDs which identify the specific request element(s) most closely associated to the error or warning, if any.", alias="inputRefIds")
    ...
    output_ref_ids: Optional[List[StrictStr]] = Field(default=None, description="An array of one or more reference IDs which identify the specific response element(s) most closely associated to the error or warning, if any.", alias="outputRefIds")
    parameters: Optional[List[ErrorParameter]] = Field(default=None, description="Various warning and error messages return one or more variables that contain contextual information about the error or waring. This is often the field or value that triggered the error or warning.")
