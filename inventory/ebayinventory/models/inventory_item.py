...
class InventoryItem(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["availability", "condition", "conditionDescription", "conditionDescriptors", "packageWeightAndSize", "product"]
