...
class Location(BaseModel):
    ...
    location_id: Optional[StrictStr] = Field(default=None, description="A unique eBay-assigned ID for the location. <br><br> <span class=\"tablenote\"> <strong>Note:</strong> This field should not be confused with the seller-defined <b>merchantLocationKey</b> value. It is the <b>merchantLocationKey</b> value which is used to identify an inventory location when working with inventory location API calls. The <strong>locationId</strong> value is only used internally by eBay.</span>", alias="locationId")
    __properties: ClassVar[List[str]] = ["address", "geoCoordinates", "locationId"]
