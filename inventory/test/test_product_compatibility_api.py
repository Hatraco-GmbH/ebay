...
class TestProductCompatibilityApi(unittest.TestCase):
    ...
    def setUp(self) -> None:
        self.api = ProductCompatibilityApi()

    def tearDown(self) -> None:
        pass

    def test_create_or_replace_product_compatibility(self) -> None:
        """Test case for create_or_replace_product_compatibility

        """
        pass

    def test_delete_product_compatibility(self) -> None:
        """Test case for delete_product_compatibility

        """
        pass

    def test_get_product_compatibility(self) -> None:
