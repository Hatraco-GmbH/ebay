...
class TestShippingCostOverride(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ShippingCostOverride:
        """Test ShippingCostOverride
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ShippingCostOverride`
        """
        ...
        if include_optional:
            return ShippingCostOverride(
                ...
                surcharge = ebayinventory.models.amount.Amount(
                    currency = '', 
                    value = '', )
            )
        else:
