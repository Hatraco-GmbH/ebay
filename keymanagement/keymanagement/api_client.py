...
from keymanagement.api_response import ApiResponse, T as ApiResponseT
import keymanagement.models
from keymanagement import rest
from keymanagement.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(keymanagement.models, klass)
