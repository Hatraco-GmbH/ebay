...
class CreateSigningKeyRequest(BaseModel):
    ...
    """ # noqa: E501
    signing_key_cipher: Optional[StrictStr] = Field(default=None, description="The enumerated value for the cipher to be used to create the signing key. Refer to <a href= \"/api-docs/developer/key-management/types/api:SigningKeyCipher\" target= \"_blank\">SigningKeyCiper</a> for the list of supported enum values. For implementation help, refer to <a href='https://developer.ebay.com/api-docs/developer/key_management/types/api:SigningKeyCipher'>eBay API documentation</a>", alias="signingKeyCipher")
    __properties: ClassVar[List[str]] = ["signingKeyCipher"]
