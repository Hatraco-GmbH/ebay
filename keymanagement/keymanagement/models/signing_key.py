...
class SigningKey(object):
    ...
    def __init__(self, creation_time=None, expiration_time=None, jwe=None, private_key=None, public_key=None, signing_key_cipher=None, signing_key_id=None, _configuration=None):  # noqa: E501
