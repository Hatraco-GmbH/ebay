...
class TestCreateSigningKeyRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CreateSigningKeyRequest:
        """Test CreateSigningKeyRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateSigningKeyRequest`
        """
        model = CreateSigningKeyRequest()
        if include_optional:
