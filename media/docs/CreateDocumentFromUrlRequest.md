...
------------ | ------------- | ------------- | -------------
**document_type** | [**DocumentTypeEnum**](DocumentTypeEnum.md) | The type of the document being created. For example, a &lt;code&gt;USER_GUIDE_OR_MANUAL&lt;/code&gt; or a &lt;code&gt;SAFETY_DATA_SHEET&lt;/code&gt;. | 
**document_url** | **str** | The URL of the document being created.&lt;br&gt;&lt;br&gt;The document referenced by the URL must be a .pdf, .png, .jpg, or .jpeg file, and must be no larger than 10 MB. | 
