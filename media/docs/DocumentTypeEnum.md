...
* `CERTIFICATE_OF_ANALYSIS` (value: `'CERTIFICATE_OF_ANALYSIS'`)

* `CERTIFICATE_OF_CONFORMITY` (value: `'CERTIFICATE_OF_CONFORMITY'`)

* `DECLARATION_OF_CONFORMITY` (value: `'DECLARATION_OF_CONFORMITY'`)

* `INSTRUCTIONS_FOR_USE` (value: `'INSTRUCTIONS_FOR_USE'`)

* `OTHER_SAFETY_DOCUMENTS` (value: `'OTHER_SAFETY_DOCUMENTS'`)

* `SAFETY_DATA_SHEET` (value: `'SAFETY_DATA_SHEET'`)

* `TROUBLE_SHOOTING_GUIDE` (value: `'TROUBLE_SHOOTING_GUIDE'`)

* `USER_GUIDE_OR_MANUAL` (value: `'USER_GUIDE_OR_MANUAL'`)

* `INSTALLATION_INSTRUCTIONS` (value: `'INSTALLATION_INSTRUCTIONS'`)

* `ACCESSIBILITY_INFORMATION` (value: `'ACCESSIBILITY_INFORMATION'`)

* `SAFETY_TEST_LAB_REPORTS` (value: `'SAFETY_TEST_LAB_REPORTS'`)

* `EEK_ENERGY_LABEL` (value: `'EEK_ENERGY_LABEL'`)

* `EEK_PRODUCT_INFORMATION_SHEET` (value: `'EEK_PRODUCT_INFORMATION_SHEET'`)

* `GENERAL_CERTIFICATE_OF_CONFORMITY` (value: `'GENERAL_CERTIFICATE_OF_CONFORMITY'`)

* `CHILDRENS_PRODUCT_CERTIFICATE` (value: `'CHILDRENS_PRODUCT_CERTIFICATE'`)
