...
class DocumentApi:
    ...
    def create_document(
        ...
        :param content_type: This header indicates the format of the request body provided by the client. Its value should be set to <strong>application/json</strong>. <br><br> For more information, refer to <a href=\"/api-docs/static/rest-request-components.html#HTTP\" target=\"_blank \">HTTP request headers</a>. (required)
    ...
    def _create_document_serialize(
        ...
        _hosts = [
            'https://api.ebay.com/commerce/media/v1_beta'
        ]
    ...
    def get_document(
        ...
        :param document_id: The unique identifier of the document for which status and metadata is being retrieved.<br><br>This value is returned in the response of the <a href=\"/develop/api/sell/media_api#method-document-createdocument\">createDocument</a> or <a href=\"/develop/api/sell/media_api#method-document-createdocumentfromurl\">createDocumentFromUrl</a> method used to create the document. (required)
    ...
    def upload_document(
        self,
        document_id: Annotated[StrictStr, Field(description="The unique identifier of the document to be uploaded.<br><br>This value is returned in the response of the <a href=\"/develop/api/sell/media_api#sell-media_api-document-createdocument\" >createDocument</a> method.")],
        content_type: Annotated[StrictStr, Field(description="This header indicates the format of the request body provided by the client. Its value should be set to <strong>multipart/form-data</strong>. <br><br> For more information, refer to <a href=\"/api-docs/static/rest-request-components.html#HTTP\" target=\"_blank \">HTTP request headers</a>.")],
        file: Annotated[StrictStr, Field(description="Path to the document file to upload as multipart form-data.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param document_id: The unique identifier of the document to be uploaded.<br><br>This value is returned in the response of the <a href=\"/develop/api/sell/media_api#sell-media_api-document-createdocument\" >createDocument</a> method. (required)
        :type document_id: str
