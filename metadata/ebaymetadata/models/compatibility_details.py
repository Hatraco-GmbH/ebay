...
class CompatibilityDetails(BaseModel):
    ...
    """ # noqa: E501
    property_name: Optional[StrictStr] = Field(default=None, description="The name of the property being described.", alias="propertyName")
    property_value: Optional[StrictStr] = Field(default=None, description="The value for the property specified in the <b>propertyName</b> field.", alias="propertyValue")
