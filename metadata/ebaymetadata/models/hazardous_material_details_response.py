...
class HazardousMaterialDetailsResponse(BaseModel):
    ...
    pictograms: Optional[List[Pictogram]] = Field(default=None, description="This array contains available hazardous materials hazard pictograms for the specified marketplace.")
    __properties: ClassVar[List[str]] = ["signalWords", "statements", "pictograms"]
