...
class MultiCompatibilityPropertyValuesResponse(BaseModel):
    """
    This type defines the response fields for the <b>getMultiCompatibilityPropertyValues</b> method.
    """ # noqa: E501
    compatibilities: Optional[List[Compatibility]] = Field(default=None, description="This container defines the compatibility details associated with the specified property name value(s).")
    ...
    __properties: ClassVar[List[str]] = ["compatibilities", "metadataVersion"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "compatibilities": [Compatibility.from_dict(_item) for _item in obj["compatibilities"]] if obj.get("compatibilities") is not None else None,
