...
class PropertyNamesResponsePropertyNameMetadata(BaseModel):
    """
    This type defines the property name metadata.
    """ # noqa: E501
    display_sequence: Optional[StrictInt] = Field(default=None, description="The numeric value indicating the ordering position of the property.", alias="displaySequence")
    __properties: ClassVar[List[str]] = ["displaySequence"]
