...
------------ | ------------- | ------------- | -------------
**eligible_items** | [**List[EligibleItem]**](EligibleItem.md) | A list of items that are eligible for a seller-initiated offer to a buyer.  &lt;br&gt;&lt;br&gt;Each element in the list contains the listing ID&lt;!-- &lt;i&gt;or&lt;/i&gt; the SKU value--&gt; of a listed item. These IDs represent the listings for which buyers have shown an interest. | [optional] 
