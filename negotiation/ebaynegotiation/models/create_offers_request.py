...
class CreateOffersRequest(BaseModel):
    ...
    """ # noqa: E501
    allow_counter_offer: Optional[StrictBool] = Field(default=None, description="If set to <code>true</code>, the buyer is allowed to make a counter-offer to the seller's offer.  <br><br><span class=\"tablenote\"><b>Note:</b> Currently, you must set this field to <code>false</code>; counter-offers are not supported in this release.</span>  <br><br><b>Default:</b> <code>false</code>", alias="allowCounterOffer")
    message: Optional[StrictStr] = Field(default=None, description="A seller-defined message related to the offer being made.  <br><br>This message is sent to the list of \"interested\" buyers.  <br><br>To increase the conversion rate of the offers a seller makes to buyers, eBay recommends you always add a customized message to your offers.  <br><br><b>Maximum length:</b> 2,000 characters")
