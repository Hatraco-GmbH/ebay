...
class EligibleItem(BaseModel):
    ...
    """ # noqa: E501
    listing_id: Optional[StrictStr] = Field(default=None, description="The unique eBay-assigned ID for an eBay listing.  <br><br>A <b>listingId</b> is assigned by eBay when a seller creates a listing with the Trading API.", alias="listingId")
