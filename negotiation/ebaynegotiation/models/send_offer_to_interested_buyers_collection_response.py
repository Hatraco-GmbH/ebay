...
class SendOfferToInterestedBuyersCollectionResponse(BaseModel):
    ...
    """ # noqa: E501
    offers: Optional[List[Offer]] = Field(default=None, description="The <b>offers</b> container returns a list of the offers sent to buyers who have shown an interest in listings included in the offer.")
