...
from ebaytaxonomy.api_client import ApiClient, RequestSerialized
from ebaytaxonomy.api_response import ApiResponse
from ebaytaxonomy.rest import RESTResponseType
...
class CategoryTreeApi:
    ...
    def fetch_item_aspects(
        self,
        category_tree_id: Annotated[StrictStr, Field(description="The unique identifier of the eBay category tree. The category tree ID for an eBay marketplace can be retrieved using the <b>getDefaultCategoryTreeId</b> method.")],
        ...
        :param category_tree_id: The unique identifier of the eBay category tree. The category tree ID for an eBay marketplace can be retrieved using the <b>getDefaultCategoryTreeId</b> method. (required)
    ...
    def get_compatibility_property_values(
        ...
        :type category_tree_id: str
        :param compatibility_property: One compatible vehicle property applicable to the specified eBay marketplace and eBay category is specified in this required filter. Compatible vehicle properties are returned in the <strong>compatibilityProperties.name</strong> field of a <strong>getCompatibilityProperties</strong> response. <br><br> For example, if you wanted to retrieve all vehicle trims for a 2018 Toyota Camry, you would set this filter as follows: <code>compatibility_property=Trim</code> and then include the following three name/value filters through one <strong>filter</strong> parameter: <code>filter=Year:2018,Make:Toyota,Model:Camry</code>.<br><br>So, putting this all together, the URI would look something like this:<br><br><pre><code>GET https://api.ebay.com/commerce/<br>taxonomy/v1/category_tree/100/<br>get_compatibility_property_values?<br><strong>category_id</strong>=6016&<strong>compatibility_property</strong>=Trim<br>&<strong>filter</strong>=Year:2018,Make:Toyota,Model:Camry</code></pre> (required)
    ...
    def get_default_category_tree_id(
        self,
        marketplace_id: Annotated[StrictStr, Field(description="The unique identifier of the eBay marketplace for which the category tree ID is requested. For a list of supported marketplace IDs, see <a href=\"/api-docs/commerce/taxonomy/static/supportedmarketplaces.html\">Marketplaces with Default Category Trees</a>.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param marketplace_id: The unique identifier of the eBay marketplace for which the category tree ID is requested. For a list of supported marketplace IDs, see <a href=\"/api-docs/commerce/taxonomy/static/supportedmarketplaces.html\">Marketplaces with Default Category Trees</a>. (required)
    ...
    @validate_call
    def get_expired_categories(
        self,
        category_tree_id: Annotated[StrictStr, Field(description="The unique identifier of the eBay category tree.<br><br>The category tree ID for an eBay marketplace can be retrieved using the <a href=\"/api-docs/commerce/taxonomy/resources/category_tree/methods/getDefaultCategoryTreeId\">getDefaultCategoryTreeId</a> method.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param category_tree_id: The unique identifier of the eBay category tree.<br><br>The category tree ID for an eBay marketplace can be retrieved using the <a href=\"/api-docs/commerce/taxonomy/resources/category_tree/methods/getDefaultCategoryTreeId\">getDefaultCategoryTreeId</a> method. (required)
        :type category_tree_id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._get_expired_categories_serialize(
            category_tree_id=category_tree_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_expired_categories_with_http_info(
        self,
        category_tree_id: Annotated[StrictStr, Field(description="The unique identifier of the eBay category tree.<br><br>The category tree ID for an eBay marketplace can be retrieved using the <a href=\"/api-docs/commerce/taxonomy/resources/category_tree/methods/getDefaultCategoryTreeId\">getDefaultCategoryTreeId</a> method.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_expired_categories_without_preload_content(
        self,
        category_tree_id: Annotated[StrictStr, Field(description="The unique identifier of the eBay category tree.<br><br>The category tree ID for an eBay marketplace can be retrieved using the <a href=\"/api-docs/commerce/taxonomy/resources/category_tree/methods/getDefaultCategoryTreeId\">getDefaultCategoryTreeId</a> method.")],
        _request_timeout: Union[
            None,
    ...
    def _get_expired_categories_serialize(
        self,
        category_tree_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/category_tree/{category_tree_id}/get_expired_categories',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_item_aspects_for_category(
        self,
        category_id: Annotated[StrictStr, Field(description="The unique identifier of the leaf category for which aspects are being requested.<br><br><span class=\"tablenote\"> <strong>Note:</strong> If the <b>category_id</b> submitted does not identify a leaf node of the tree, this call returns an error. </span>")],
        category_tree_id: Annotated[StrictStr, Field(description="The unique identifier of the eBay category tree. The category tree ID for an eBay marketplace can be retrieved using the <b>getDefaultCategoryTreeId</b> method.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param category_id: The unique identifier of the leaf category for which aspects are being requested.<br><br><span class=\"tablenote\"> <strong>Note:</strong> If the <b>category_id</b> submitted does not identify a leaf node of the tree, this call returns an error. </span> (required)
        :type category_id: str
        :param category_tree_id: The unique identifier of the eBay category tree. The category tree ID for an eBay marketplace can be retrieved using the <b>getDefaultCategoryTreeId</b> method. (required)
        :type category_tree_id: str
        :param _request_timeout: timeout setting for this request. If one
