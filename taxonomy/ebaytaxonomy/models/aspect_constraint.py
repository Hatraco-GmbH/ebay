...
class AspectConstraint(BaseModel):
    ...
    """ # noqa: E501
    aspect_applicable_to: Optional[List[StrictStr]] = Field(default=None, description="This value indicate if the aspect identified by the <b>aspects.localizedAspectName</b> field is a product aspect (relevant to catalog products in the category) or an item/instance aspect, which is an aspect whose value will vary based on a particular instance of the product.", alias="aspectApplicableTo")
    ...
    aspect_enabled_for_variations: Optional[StrictBool] = Field(default=None, description="A value of <code>true</code> indicates that this aspect can be used to help identify item variations.", alias="aspectEnabledForVariations")
    aspect_format: Optional[StrictStr] = Field(default=None, description="<i>Returned only if</i> the value of <b>aspectDataType</b> identifies a data type that requires specific formatting. Currently, this field provides formatting hints as follows: <ul> <li><b>DATE</b>: <code>YYYY</code>, <code>YYYYMM</code>, <code>YYYYMMDD</code></li> <li><b>NUMBER</b>: <code>int32</code>, <code>double</code></li> </ul>", alias="aspectFormat")
    ...
    aspect_required: Optional[StrictBool] = Field(default=None, description="A value of <code>true</code> indicates that this aspect is required when offering items in the specified category.", alias="aspectRequired")
    aspect_usage: Optional[StrictStr] = Field(default=None, description="The enumeration value returned in this field will indicate if the corresponding aspect is recommended or optional.<br><br><span class=\"tablenote\"> <strong>Note:</strong> This field is always returned, even for hard-mandated/required aspects (where <code><strong>aspectRequired</strong>: true</code>). The value returned for required aspects will be <code>RECOMMENDED</code>, but they are actually required and a seller will be blocked from listing or revising an item without these aspects. </span> For implementation help, refer to <a href='https://developer.ebay.com/api-docs/commerce/taxonomy/types/txn:AspectUsageEnum'>eBay API documentation</a>", alias="aspectUsage")
    expected_required_by_date: Optional[StrictStr] = Field(default=None, description="The expected date after which the aspect will be required.<br><br><span class=\"tablenote\"> <strong>Note:</strong> The value returned in this field specifies only an approximate date, which may not reflect the actual date after which the aspect is required.</span>", alias="expectedRequiredByDate")
    item_to_aspect_cardinality: Optional[StrictStr] = Field(default=None, description="Indicates whether this aspect can accept single or multiple values for items in the specified category.<br><br><span class=\"tablenote\"> <strong>Note:</strong> Up to 30 values can be supplied for aspects that accept multiple values.</span> For implementation help, refer to <a href='https://developer.ebay.com/api-docs/commerce/taxonomy/types/txn:ItemToAspectCardinalityEnum'>eBay API documentation</a>", alias="itemToAspectCardinality")
    aspect_advanced_data_type: Optional[StrictStr] = Field(default=None, description="Indicates additional data type requirements for the aspect. For example, <code>NUMERIC_RANGE</code> indicates that the aspect value must be in numeric range format.<br><br><span class=\"tablenote\"> <strong>Note:</strong> Currently only <code>NUMERIC_RANGE</code> is supported.</span> For implementation help, refer to <a href='https://developer.ebay.com/api-docs/commerce/taxonomy/types/txn:AspectAdvancedDataTypeEnum'>eBay API documentation</a>", alias="aspectAdvancedDataType")
    __properties: ClassVar[List[str]] = ["aspectApplicableTo", "aspectDataType", "aspectEnabledForVariations", "aspectFormat", "aspectMaxLength", "aspectMode", "aspectRequired", "aspectUsage", "expectedRequiredByDate", "itemToAspectCardinality", "aspectAdvancedDataType"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "aspectAdvancedDataType": obj.get("aspectAdvancedDataType")
        })
        return _obj
