...
class CategorySuggestion(BaseModel):
    ...
    category_tree_node_ancestors: Optional[List[AncestorReference]] = Field(default=None, description="An ordered list of category references that describes the location of the suggested category in the specified category tree. The list identifies the category's ancestry as a sequence of parent nodes, from the current node's immediate parent to the root node of the category tree.<br><br><span class=\"tablenote\"> <strong>Note:</strong> The root node of a full default category tree includes <b>categoryId</b> and <b>categoryName</b> fields, but their values should not be relied upon. They provide no useful information for application development.</span>", alias="categoryTreeNodeAncestors")
    category_tree_node_level: Optional[StrictInt] = Field(default=None, description="The absolute level of the category tree node in the hierarchy of its category tree.<br><br><span class=\"tablenote\"> <strong>Note:</strong> The root node of any full category tree is always at level <code><b>0</b></code>.</span>", alias="categoryTreeNodeLevel")
