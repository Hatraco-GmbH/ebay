...
class CategoryTreeNode(BaseModel):
    ...
    category_tree_node_level: Optional[StrictInt] = Field(default=None, description="The absolute level of the current category tree node in the hierarchy of its category tree.<br><br><span class=\"tablenote\"> <strong>Note:</strong> The root node of any full category tree is always at level <code><b>0</b></code>. </span>", alias="categoryTreeNodeLevel")
    child_category_tree_nodes: Optional[List[CategoryTreeNode]] = Field(default=None, description="An array of one or more category tree nodes that are the immediate children of the current category tree node, as well as their children, recursively down to the leaf nodes.<br><br><i>Returned only if</i> the current category tree node is not a leaf node (the value of <b>leafCategoryTreeNode</b> is <code>false</code>).", alias="childCategoryTreeNodes")
    leaf_category_tree_node: Optional[StrictBool] = Field(default=None, description="A value of <code>true</code> indicates that the current category tree node is a leaf node (it has no child nodes). A value of <code>false</code> indicates that the current node has one or more child nodes, which are identified by the <b>childCategoryTreeNodes</b> array.<br><br><i>Returned only if</i> the value of this field is <code>true</code>.", alias="leafCategoryTreeNode")
    parent_category_tree_node_href: Optional[StrictStr] = Field(default=None, description="The href portion of the <b>getCategorySubtree</b> call that retrieves the subtree below the parent of this category tree node.<br><br><i>Not returned if</i> the current category tree node is the root node of its tree.", alias="parentCategoryTreeNodeHref")
