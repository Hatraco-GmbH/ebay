...
class CompatibilityPropertyValue(BaseModel):
    ...
    """ # noqa: E501
    value: Optional[StrictStr] = Field(default=None, description="Each <strong>value</strong> field shows one applicable compatible vehicle property value. The values that are returned will depend on the specified eBay marketplace, specified eBay category, and filters in the request.")
