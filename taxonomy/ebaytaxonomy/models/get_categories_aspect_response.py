...
class GetCategoriesAspectResponse(BaseModel):
    ...
    category_tree_version: Optional[StrictStr] = Field(default=None, description="The version of the category tree that is returned in the <b>categoryTreeId</b> field.", alias="categoryTreeVersion")
    ...
    __properties: ClassVar[List[str]] = ["categoryTreeId", "categoryTreeVersion", "categoryAspects"]
